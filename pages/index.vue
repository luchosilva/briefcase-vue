    ...
    <div class="px-5 w-full">
      <div class="grid md:grid-cols-12 gap-5 w-full items-center justify-items-center">
        <div class="max-w-md text-center col-span-4">
          <img :src="urlAvatar.href" alt="avatar" class="rounded-full w-[30dvh] h-[30dvh] mx-auto" />
...
const urlAvatar = new URL("https://media.licdn.com/dms/image/D4E03AQFZ35-GIWO2Hg/profile-displayphoto-shrink_800_800/0/1699043197238?e=1716422400&v=beta&t=LT0a2h1A5LHWf8cEWsUjHcxMPCsgemuLrZKUxQeXpsY")
